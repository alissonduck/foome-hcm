...
/**
 * Props para o componente CompanyRegistrationForm
 */
...
/**
 * Schema de validação para o formulário de dados do administrador
 */
...
/**
 * Schema de validação para o formulário de dados da empresa
 */
 ...
 */
export default function CompanyRegistrationForm({ userId }: CompanyRegistrationFormProps) {
  const [step, setStep] = useState<"admin" | "company" | "success">("admin")
  const [isLoading, setIsLoading] = useState(false)
  const [adminData, setAdminData] = useState<z.infer<typeof adminFormSchema> | null>(null)
   ...
   */
  async function onSubmitAdmin(values: z.infer<typeof adminFormSchema>) {
    setAdminData(values)
    setStep("company")
  }
   ...
   * @param values Valores do formulário
   */
  async function onSubmitCompany(values: z.infer<typeof companyFormSchema>) {
    try {
      setIsLoading(true)
          ...
          <Tabs value={step} className="w-full">
            ...
            <TabsContent value="admin" className="m-0 p-6 sm:p-8">
              <Form {...adminForm}>
                <form onSubmit={adminForm.handleSubmit(onSubmitAdmin)} className="space-y-5">
                  ...
                  <Button type="submit" className="w-full h-11 mt-8 rounded-lg font-medium">
                    Próximo
                  </Button>
                </form>
              </Form>
              ...
              <Form {...companyForm}>
                <form onSubmit={companyForm.handleSubmit(onSubmitCompany)} className="space-y-5">
                  <div className="space-y-2 mb-6">
                    ...
                    <p className="text-sm text-muted-foreground">Informe os dados da sua empresa</p>
                  </div>
                      ...
                      <FormItem>
                        ...
                        <FormControl>
                          <div className="relative">
                            ...
                            <Input placeholder="Empresa XYZ Ltda." className="pl-10 h-11 rounded-lg" {...field} />
                          </div>
                        </FormControl>
                        <FormMessage />
                      </FormItem>
                      ...
                      <FormItem>
                        ...
                        <FormControl>
                          <div className="relative">
                            ...
                            <Input placeholder="12.345.678/0001-90" className="pl-10 h-11 rounded-lg" {...field} />
                          </div>
                        </FormControl>
                        <FormMessage />
                      </FormItem>
                      ...
                      <FormItem>
                        ...
                        <Select onValueChange={field.onChange} defaultValue={field.value}>
                          ...
                          <SelectContent>
                            ...
                            <SelectItem value="10000+">Mais de 10000 funcionários</SelectItem>
                          </SelectContent>
                        </Select>
                        <FormMessage />
                      </FormItem>
                  ...
                  <div className="flex gap-3 mt-8">
                    ...
                    <Button type="submit" className="flex-1 h-11 rounded-lg font-medium" disabled={isLoading}>
                      {isLoading ? (
                        <>
            ...
            <TabsContent value="success" className="m-0">
              <div className="flex flex-col items-center justify-center py-16 text-center">
                ...
                <h3 className="text-2xl font-bold mb-3">Cadastro concluído com sucesso!</h3>
                <p className="text-muted-foreground mb-8 max-w-md px-4">
                  Sua empresa foi cadastrada com sucesso. Agora você pode começar a gerenciar seus funcionários na
                  plataforma FooMe.
                </p>
                <Button onClick={goToDashboard} className="h-12 px-10 rounded-lg font-medium text-base">
                  Ir para o Dashboard
                </Button>
              </div>
            </TabsContent>
